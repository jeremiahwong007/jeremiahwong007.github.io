...
const mood_detector_desc = "A program that utilizes machine learning to detect a user's facial expression. This was created using TensorFlow and exisitng datasets online."
